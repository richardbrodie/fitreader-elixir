defmodule Fit.Sdk.Fields do
  @_msg_0 %{
    0 => {:filetype, :enum_file, 0, 0},
    1 => {:manufacturer, :enum_manufacturer, 0, 0},
  ...
  @_msg_3 %{
    ...
    1 => {:gender, :enum_gender, 0, 0},
    2 => {:age, :raw, 0, 0},
    3 => {:height, :uint8, 100, 0},
    4 => {:weight, :uint16, 10, 0},
    5 => {:language, :enum_language, 0, 0},
    6 => {:elev_setting, :enum_display_measure, 0, 0},
    7 => {:weight_setting, :enum_display_measure, 0, 0},
    ...
    12 => {:hr_setting, :enum_display_heart, 0, 0},
    13 => {:speed_setting, :enum_display_measure, 0, 0},
    14 => {:dist_setting, :enum_display_measure, 0, 0},
    16 => {:power_setting, :enum_display_power, 0, 0},
    17 => {:activity_class, :enum_activity_class, 0, 0},
    18 => {:position_setting, :enum_display_position, 0, 0},
    21 => {:temperature_setting, :enum_display_measure, 0, 0},
    22 => {:local_id, :user_local_id, 0, 0},
    23 => {:global_id, :byte, 0, 0},
    30 => {:height_setting, :enum_display_measure, 0, 0}
  }
  def get(3, key) do
    @_msg_3[key]
  end
  ...
  @_msg_6 %{
    254 => {:message_index, :message_index, 0, 0},
    0 => {:name, :string, 0, 0},
    1 => {:sport, :enum_sport, 0, 0},
    2 => {:sub_sport, :enum_sub_sport, 0, 0},
  ...
  @_msg_18 %{
    ...
    0 => {:event, :enum_event, 0, 0},
    1 => {:event_type, :enum_event_type, 0, 0},
    2 => {:start_time, :date_time, 0, 0},
    3 => {:start_position_lat, :coordinates, 0, 0},
    4 => {:start_position_long, :coordinates, 0, 0},
    5 => {:sport, :enum_sport, 0, 0},
    6 => {:sub_sport, :enum_sub_sport, 0, 0},
    ...
    28 => {:trigger, :enum_session_trigger, 0, 0},
    ...
    46 => {:pool_length_unit, :enum_display_measure, 0, 0},
  ...
  @_msg_19 %{
    ...
    23 => {:intensity, :enum_intensity, 0, 0},
    24 => {:lap_trigger, :enum_lap_trigger, 0, 0},
    25 => {:sport, :enum_sport, 0, 0},
    ...
    38 => {:swim_stroke, :enum_swim_stroke, 0, 0},
    39 => {:sub_sport, :enum_sub_sport, 0, 0},
  ...
  @_msg_23 %{
    ...
    2 => {:manufacturer, :enum_manufacturer, 0, 0},
    ...
    11 => {:battery_status, :enum_battery_status, 0, 0},
    18 => {:sensor_position, :enum_body_location, 0, 0},
    19 => {:descriptor, :string, 0, 0},
    20 => {:ant_transmission_type, :uint8z, 0, 0},
    21 => {:ant_device_number, :uint16z, 0, 0},
    22 => {:ant_network, :enum_ant_network, 0, 0},
    23 => {:serial_number, :raw, 0, 0},
    24 => {:sensor_serial_number, :raw, 0, 0},
    25 => {:source_type, :enum_source_type, 0, 0},
  ...
  @_msg_34 %{
    ...
    2 => {:type, :enum_activity, 0, 0},
    3 => {:event, :enum_event, 0, 0},
    4 => {:event_type, :enum_event_type, 0, 0},
